...
<nav class="navbar navbar-inverse">
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><i class="glyphicon glyphicon-eye-open"></i> </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="menu-crud">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-menu-hamburger"></i> <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="listar-curso.php">Menu</a></li>
            <li><a href="cadastrar-curso.php">Incluir</a></li>
